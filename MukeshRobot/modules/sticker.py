...
from MuskeshRobot import dispatcher
from MukeshRobot import telethn as bot
from MukeshRobot.events import register as asau
from MukeshRobot.modules.disable import DisableAbleCommandHandler
from Vipboy.covert import convert_gif
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./Madara/resources/default.ttf"
